...
function resolveInvitation(variant) {
    ...
    const navigation = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$wedding$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["wedding"].navigation.filter((item)=>spec.showRsvp || item.id !== "rsvp").filter((item)=>!isBride || item.id !== "request").map((item)=>{
...
async function submitRsvp(payload) {
    ...
    ;
    const hosted = payload.invitationSource === "groom" ? process.env.NEXT_PUBLIC_RSVP_API_URL?.trim() : "";
    try {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0wo-n0x._.js.map